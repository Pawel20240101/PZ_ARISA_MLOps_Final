...
if __name__ == "__main__":
    ...
    if local_model_path.exists():
        ...
        if model_params_path.exists():
            ...
            logger.info(f"Loaded params from {model_params_path}")

        udc_path = MODELS_DIR / "udc.pkl"
        estimator_path = MODELS_DIR / "estimator.pkl"
        if udc_path.exists() and estimator_path.exists():
